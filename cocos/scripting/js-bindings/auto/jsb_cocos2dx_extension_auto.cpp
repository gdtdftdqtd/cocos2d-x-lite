...
static bool js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough(se::State& s)
{
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough : Error processing arguments");
        bool result = cobj->checkFreeMemoryIsEnough(arg0);
        ok &= boolean_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough)
...
bool js_register_cocos2dx_extension_AssetsManagerEx(se::Object* obj)
{
    ...
    cls->defineFunction("checkFreeMemoryIsEnough", _SE(js_cocos2dx_extension_AssetsManagerEx_checkFreeMemoryIsEnough));
