...
SE_DECLARE_FUNC(js_creator_graphics_GraphicsNode_polygon);
SE_DECLARE_FUNC(js_creator_graphics_GraphicsNode_setGraphicsOpacity);
SE_DECLARE_FUNC(js_creator_graphics_GraphicsNode_fillPolygon);
...
SE_DECLARE_FUNC(js_creator_graphics_GraphicsNode_getGraphicsOpacity);
