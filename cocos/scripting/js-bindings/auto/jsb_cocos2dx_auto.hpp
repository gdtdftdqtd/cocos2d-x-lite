...
SE_DECLARE_FUNC(js_cocos2dx_Texture2D_getFormatForString);
SE_DECLARE_FUNC(js_cocos2dx_Texture2D_setDefaultAlphaPixelFormat);
SE_DECLARE_FUNC(js_cocos2dx_Texture2D_setSpecialAlphaPixelFormat);
SE_DECLARE_FUNC(js_cocos2dx_Texture2D_getDefaultAlphaPixelFormat);
SE_DECLARE_FUNC(js_cocos2dx_Texture2D_getSpecialAlphaPixelFormat);
...
SE_DECLARE_FUNC(js_cocos2dx_Configuration_supportsETC2);
...
SE_DECLARE_FUNC(js_cocos2dx_Configuration_checkForEtc2);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_basename);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_isReverseSuffixFileExist);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_removeFile);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getDataFromFile);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getReverseSuffixContents);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_basedir);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_writeToFile);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getReverseSuffixFilePassword);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_listFiles);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_writeValueVectorToFile);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getReverseSuffixFilename);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_getWritableUpdatePath);
...
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_RemoveFileSuffix);
SE_DECLARE_FUNC(js_cocos2dx_FileUtils_fullPathForFilenameByReverseSuffix);
...
extern se::Object* __jsb_cocos2d_JumpRoateTo_proto;
extern se::Class* __jsb_cocos2d_JumpRoateTo_class;

bool js_register_cocos2d_JumpRoateTo(se::Object* obj);
bool register_all_cocos2dx(se::Object* obj);
SE_DECLARE_FUNC(js_cocos2dx_JumpRoateTo_create);
SE_DECLARE_FUNC(js_cocos2dx_JumpRoateTo_JumpRoateTo);
...
SE_DECLARE_FUNC(js_cocos2dx_Label_setWordSpacing);
...
SE_DECLARE_FUNC(js_cocos2dx_Label_getWordSpacing);
...
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_removeTilesAway);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_setLayerOrientation);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_setTileOpacity);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_getBigMapTileGIDAt);
...
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_getTileCoords);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_getIsBigMap);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_setTileGID);
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_showTilesBeyond);
...
SE_DECLARE_FUNC(js_cocos2dx_TMXLayer_removeBigMapTileAt);
