...
bool js_cocos2dx_FileUtils_basename(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_FileUtils_getReverseSuffixContents(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_FileUtils_basedir(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_FileUtils_writeToFile(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_FileUtils_getReverseSuffixFilePassword(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_FileUtils_getReverseSuffixFilename(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_FileUtils_getWritableUpdatePath(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_FileUtils_RemoveFileSuffix(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_FileUtils_fullPathForFilenameByReverseSuffix(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_Label_setWordSpacing(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_Label_getWordSpacing(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_TMXLayer_removeTilesAway(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_TMXLayer_getBigMapTileGIDAt(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_TMXLayer_removeBigMapTileAt(JSContext *cx, uint32_t argc, jsval *vp);
